...
/* GÖREV 2:
		paragrafOlustur fonksiyonuna aşağıdakileri uygulayın.
			...
			3. cumlelereDonustur fonksiyonu geriçağırım(canpm llback) için fonksiyonun üçüncü parametresi olarak alınacak
...
console.log(
	emojileriDonustur(
		"Selam :) Nasılsın :D Bugünkü olay çok komikti :P ama sonra çok şaşırdık 😱 biraz da üzüldük :( ama yine de seviliyorsun <3",
		emojiler
	)
);
